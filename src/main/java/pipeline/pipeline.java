...
private Tokenizer_Indonesia_withClitics tokenizer_clitics;
private Tokenizer_Indonesia_withoutClitics tokenizer;
private postag_indonesia postag;

    public pipeline() throws IOException {
        String[] annotators = {"tokenizer_clitics", "tokenizer", "postag"};
        initAnnotators(annotators);
    }

    public pipeline(String[] annotators) throws IOException {
        initAnnotators(annotators);
    ...
    public void initAnnotators(String[] annotators) throws IOException{
        for(String annotator : annotators) {
            switch (annotator.trim()) {
                case "tokenizer":
                    this.tokenizer_clitics = Tokenizer_Indonesia_withClitics.initialize();
                    break;
                case "tokenizer_clitics":
